...
export const ENEMY_DEFS = {
  ...
  toad_beast: {
    ...
    attributes: ['tongue-snatch', 'telegraphs'],
    tongueSnatch: true,
    spawn:      { fromBiome: 'jungle' },
  },
  ...
  onion: {
    ...
    attributes: ['layered', 'teary', 'telegraphs'],
    onionLayer: 3,
    spawn:      { fromBiome: 'jungle' },
  },
  ...
  fire_centipede: {
    ...
    attributes: ['burn', 'poison', 'telegraphs'],
    burnHit:    true,
    burnHitAmount: 1,
    poisonHit:  true,
    poisonHitAmount: 1,
  ...
  dark_bone_demon: {
    ...
    attributes: ['demon-flip', 'telegraphs'],
    demonFlip:  true,
  ...
  // ── The Void (void trial only — spawn.voidTrial) ─────────────
  void_maw: {
    hp:         2,
    dmg:        [1, 2],
    type:       'undead',
    ...
    goldDrop:   [1, 2],
    xpDrop:     2,
    blurb:      'A laughing knot of void smoke and green fire. It strikes before you can react — and leaves a piece of itself behind when it dies.',
    attributes: ['fast', 'death-split'],
    deathSplitBurst: 1,
    voidSpawnWeight: 10,
    spawn:      { voidTrial: true, voidMinTier: 1 },
  },
  void_ghast: {
    hp:         2,
    dmg:        [1, 1],
    ...
    goldDrop:   [1, 2],
    xpDrop:     3,
    blurb:      'A floating predator with no legs and too many teeth. The Void watches back through its eyes.',
    attributes: ['void-gaze'],
    voidGaze:             true,
    voidGazeProcChance:   0.5,
    voidGazeMaxStacks:    3,
    voidGazeFizzlePerStack: 0.05,
    voidSpawnWeight: 10,
    spawn:      { voidTrial: true, voidMinTier: 1 },
  },
  hook_crawler: {
    ...
    goldDrop:   [2, 4],
    xpDrop:     5,
    blurb:      'Obsidian hooks and hungry eyes. Every blow hooks deeper into the armor you stacked off the floor.',
    attributes: ['telegraphs', 'armor-rend'],
    armorRend:  1,
    leaderEligible: true,
    voidSpawnWeight: 8,
    spawn:      { voidTrial: true, voidMinTier: 1, voidMinFloor: 10 },
  },
  shard_ravager: {
    hp:         4,
    dmg:        [2, 4],
    ...
    goldDrop:   [2, 4],
    xpDrop:     6,
    blurb:      'Crystalline plates guard a void core. The first blow cracks the shell — the shrapnel is yours to keep.',
    attributes: ['telegraphs', 'shatter-shell'],
    shatterShell: true,
    shatterPct:   0.25,
    leaderEligible: true,
    voidSpawnWeight: 6,
    spawn:      { voidTrial: true, voidMinTier: 2 },
  },
  void_behemoth: {
    hp:         8,
    dmg:        [3, 4],
    ...
    goldDrop:   [4, 6],
    xpDrop:     8,
    blurb:      'A floating crown of purple stone and pink void-fire. Slow, inevitable, and built to waste your time.',
    attributes: ['telegraphs', 'obsidian-plate'],
    obsidianCharges: 3,
    leaderEligible: true,
    voidSpawnWeight: 2,
    voidMaxPerFloor: 1,
    spawn:      { voidTrial: true, voidMinTier: 3, voidMinFloor: 20 },
  },
  rift_lich: {
    hp:         12,
    dmg:        [2, 4],
    ...
    goldDrop:   [3, 5],
    xpDrop:     7,
    blurb:      'The hood hides a face best forgotten. The chest maw drinks your magic — then your life.',
    attributes: ['telegraphs', 'rift-maw'],
    riftMaw:          true,
    riftMawManaPct:   0.10,
    riftMawHpPct:     0.05,
    voidSpawnWeight: 2,
    spawn:      { voidTrial: true, voidMinTier: 3, voidMinFloor: 25 },
  },
  void_overseer: {
    hp:         18,
    dmg:        [3, 5],
    ...
    xpDrop:     20,
    isBoss:     true,
    blurb:      'A crown of void stone and hungry tentacles. Its central eye burns with magenta fire — the trial ends here, or you do.',
    attributes: ['boss', 'telegraphs'],
    spawn:      { voidTrial: true, voidBoss: true },
  },
}

/** Finale boss for all void trials (v1 — same art/stats per tier; per-tier bosses may follow). */
export const VOID_TRIAL_BOSS_ID = 'void_overseer'
